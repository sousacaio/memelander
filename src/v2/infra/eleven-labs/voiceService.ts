...
export const textToSpeech = async (voiceId: string, text: string) => {
    const body = {
        text: text,
        voice: voiceId,
        language: 'pt-BR'
...
export const speechToSpeech = async (voiceId: string, urlFile: string) => {
...
export const post = async (url: string, body: any, responseType = 'json', contentType = 'application/json') => {
    const header = {
